...
import com.hasindu.noteme.adapter.NoteAdapter
import com.hasindu.noteme.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(R.layout.fragment_home) , SearchView.OnQueryTextListener,MenuProvider{
    ...
    private fun updateUI(note: List<com.hasindu.noteme.model.Note>?){
        if(note != null){
            if(note.isNotEmpty()){
